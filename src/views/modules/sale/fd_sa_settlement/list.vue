...
export default {
  ...
  methods: {
    ...
    getMaterialList () {
      ...
      FdSaSettlementService.list(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        case 'delete':
          ...
          FdSaSettlementService.delete(getList[0].id).then(res => {
        ...
        case 'obsolete':
          ...
          FdSaSettlementService.obsolete({
            ids: result,
            check: false
          }).then(res => {
            this.$message.success(res.msg)
        ...
        case 'copy':
          ...
          let id = getList[0].id
          FdSaSettlementService.copy(id).then(res => {
            this.$message.success(res.msg)
          })
          break
      }
