...
import FdSaCalculationService from 'service/modules/sale/fd_sa_calculation/fd-sa-calculation-service'
export default {
  name: 'dynamic',
  data () {
    return {
  ...
  methods: {
    ...
    getMaterialList () {
      ...
      FdSaCalculationService.list(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        ...
        case 'disable':
          ...
          FdSaCalculationService.disable({
            ids: result
          }).then(res => {
            this.$message.success(res.msg)
          })
        ...
        case 'obsolete':
          ...
          FdSaCalculationService.obsolete({
            ids: result,
            check: false
          }).then(res => {
            this.$message.success(res.msg)
        ...
        case 'copy':
          ...
          let id = getList[0].id
          FdSaCalculationService.copy(id).then(res => {
            this.$message.success(res.msg)
          })
          break
      }
