...
export default {
  ...
  methods: {
    ...
    getMaterialList () {
      ...
      SaContractService.list(params).then(res => {
        console.log(res)
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        ...
        case 'copy':
          ...
          let id = getList[0].id
          SaContractService.copy(id).then(res => {
            this.$message.success(res.data)
          })
          break
      }
