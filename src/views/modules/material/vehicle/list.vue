...
import VehicleService from 'service/modules/material/vehicle/vehicle-service'
export default {
  name: 'dynamic',
  data () {
    return {
  ...
  methods: {
    ...
    getMaterialList () {
      ...
      VehicleService.list(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        ...
        case 'delete':
          ...
          VehicleService.delete(result).then(res => {
