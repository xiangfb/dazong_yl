  ...
  methods: {
    ...
    getMaterialList (one) {
      if (this.formatStyle === 'FORMAT_TREE_LIST') {
        InventoryOrganizationService.trees().then(tree => {
          if (tree.success) {
    ...
    getData (id) {
      ...
      InventoryOrganizationService.formData(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        case 'delete':
          ...
          InventoryOrganizationService.delete(result).then(res => {
        ...
        case 'enable':
          ...
          InventoryOrganizationService.enable({
            ids: result
          }).then(res => {
        ...
        case 'disable':
          ...
          InventoryOrganizationService.disable({
            ids: result
          }).then(res => {
