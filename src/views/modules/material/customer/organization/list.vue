  ...
  methods: {
    ...
    getMaterialList (one) {
      if (this.formatStyle === 'FORMAT_TREE_LIST') {
        CustomerOrganizationService.trees().then(tree => {
          if (tree.success) {
    ...
    getData (id) {
      ...
      CustomerOrganizationService.formData(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        case 'delete':
          ...
          CustomerOrganizationService.delete(result).then(res => {
        ...
        case 'enable':
          ...
          CustomerOrganizationService.enable({
            ids: result
          }).then(res => {
        ...
        case 'disable':
          ...
          CustomerOrganizationService.disable({
            ids: result
          }).then(res => {
