...
import PersonService from 'service/modules/material/person/person-service'
export default {
  name: 'dynamic',
  data () {
    return {
  ...
  methods: {
    ...
    getMaterialList () {
      ...
      PersonService.list(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        ...
        case 'delete':
          ...
          PersonService.delete(result).then(res => {
