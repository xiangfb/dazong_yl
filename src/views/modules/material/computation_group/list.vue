...
export default {
  ...
  methods: {
    ...
    getMaterialList () {
      ...
      ComputationGroupService.list(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        ...
        case 'delete':
          ...
          ComputationGroupService.delete(result).then(res => {
        ...
        case 'enable':
          ...
          ComputationGroupService.enable({
            ids: result
          }).then(res => {
        ...
        case 'disable':
          ...
          ComputationGroupService.disable({
            ids: result
          }).then(res => {
