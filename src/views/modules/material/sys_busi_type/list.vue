...
export default {
  ...
  methods: {
    ...
    getMaterialList () {
      ...
      SysBusiTypeService.list(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        ...
        case 'delete':
          ...
          SysBusiTypeService.delete(result).then(res => {
            this.$message.success('删除成功')
            this.getMaterialList()
          })
          break
        case 'synchronization':
          SysBusiTypeService.syn({
