...
export default {
  ...
  methods: {
    ...
    getData (id) {
      ...
      VendorService.formData(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        case 'delete':
          ...
          VendorService.delete(result).then(res => {
        ...
        case 'distribute':
          ...
          VendorService.organizationTrees().then(res => {
            if (res.success) {
        ...
        case 'distributeSearch':
          ...
          VendorService.findAllocate(getList[0].id).then(res => {
            if (res.success) {
              console.log(res)
