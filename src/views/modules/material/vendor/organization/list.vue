  ...
  methods: {
    ...
    getMaterialList (one) {
      if (this.formatStyle === 'FORMAT_TREE_LIST') {
        VendorOrganizationService.trees().then(tree => {
          if (tree.success) {
    ...
    getData (id) {
      ...
      if (this.searchId) {
        params.search = [{ key: 'vencId', op: 'eq', val: this.searchId }]
      }
      ...
      VendorOrganizationService.formData(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        case 'delete':
          ...
          VendorOrganizationService.delete(result).then(res => {
        ...
        case 'enable':
          ...
          VendorOrganizationService.enable({
            ids: result
          }).then(res => {
        ...
        case 'disable':
          ...
          VendorOrganizationService.disable({
            ids: result
          }).then(res => {
