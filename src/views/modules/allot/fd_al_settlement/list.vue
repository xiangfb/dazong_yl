...
export default {
  ...
  methods: {
    ...
    getMaterialList () {
      ...
      FdAlSettlementService.list(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        case 'delete':
          ...
          FdAlSettlementService.delete(getList[0].id).then(res => {
        ...
        case 'obsolete':
          ...
          FdAlSettlementService.obsolete({
            ids: result,
            check: false
          }).then(res => {
            this.$message.success(res.msg)
        ...
        case 'copy':
          ...
          let id = getList[0].id
          FdAlSettlementService.copy(id).then(res => {
            this.$message.success(res.msg)
          })
          break
      }
