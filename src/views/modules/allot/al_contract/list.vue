...
import AlContractService from 'service/modules/allot/al_contract/al-contract-service'
export default {
  name: 'dynamic',
  data () {
    return {
  ...
  methods: {
    ...
    getMaterialList () {
      ...
      AlContractService.list(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        ...
        case 'copy':
          ...
          let id = getList[0].id
          AlContractService.copy(id).then(res => {
            this.$message.success(res.data)
          })
          break
        case 'add_notice':
          ...
          this.$router.push({
            ...
            query: {
              id: this.butResource[e].id,
              type: e,
              contractId: getList[0].id,
              contractCode: getList[0].contractCode
            }
          })
          break
      }
