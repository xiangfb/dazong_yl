...
export default {
  ...
  methods: {
    ...
    getMaterialList () {
      ...
      FdAlCalculationService.list(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        ...
        case 'disable':
          ...
          FdAlCalculationService.disable({
            ids: result
          }).then(res => {
            this.$message.success(res.msg)
          })
        ...
        case 'obsolete':
          ...
          FdAlCalculationService.obsolete({
            ids: result,
            check: false
          }).then(res => {
            this.$message.success(res.msg)
        ...
        case 'copy':
          ...
          let id = getList[0].id
          FdAlCalculationService.copy(id).then(res => {
            this.$message.success(res.msg)
          })
          break
      }
