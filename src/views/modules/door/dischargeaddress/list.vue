...
export default {
  ...
  methods: {
    ...
    getMaterialList () {
      ...
      DischargeaddressService.list(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        case 'delete':
          ...
          DischargeaddressService.delete(result).then(res => {
        ...
        case 'enable':
          ...
          DischargeaddressService.enable({
            ids: result
          }).then(res => {
        ...
        case 'disable':
          ...
          DischargeaddressService.disable({
            ids: result
          }).then(res => {
