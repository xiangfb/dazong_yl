...
import QueueMatchService from 'service/modules/door/queue_match/queue-match-service'
...
export default {
  ...
  methods: {
    ...
    getMaterialList () {
      ...
      QueueMatchService.list(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        case 'delete':
          ...
          QueueMatchService.delete(result).then(res => {
