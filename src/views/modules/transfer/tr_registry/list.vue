...
export default {
  ...
  methods: {
    popupConfirm () { // 弹窗资源点击确定触发  data为已选跨页数据
      ...
      TrRegistryService.updateWeighsByNotice({
        noticeId: noticeId,
    ...
    getMaterialList () {
      ...
      TrRegistryService.list(params).then(res => {
        if (res.success) {
    ...
    supplementCard (code, id) {
      TrRegistryService.supplementCard({
        id: id,
        cardCode: code
      }).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        ...
        case 'againMatch':
          ...
          TrRegistryService.againMatch(getList[0].id).then(res => {
            if (res.success) {
              this.$message.success('操作成功')
              this.getMaterialList()
            }
        ...
        case 'updateNotice':
          ...
          GlobalService.optimusPrimePopup('347').then(res => {
            if (res.success) {
        ...
        case 'safeUpdate':
          ...
          TrRegistryService.getSub(getList[0].id).then(res => {
            if (!res.data[0] || res.data[0].deWeigh01 === null || res.data[0].deWeigh01 === '' ||
            res.data[0].reWeigh01 === null || res.data[0].reWeigh01 === '') {
        ...
        case 'copy':
          ...
          let id = getList[0].id
          TrRegistryService.copy(id).then(res => {
            if (res.success) {
              this.$message.success('操作成功')
              this.getMaterialList()
            }
        ...
        case 'upControlPoint':
          ...
          console.log(getList[0])
          TrRegistryService.upControlPoint({
            id: getList[0].id,
        ...
        case 'downControlPoint':
          ...
          console.log(getList[0])
          TrRegistryService.downControlPoint({
            id: getList[0].id,
        ...
        case 'picture':
          ...
          console.log(getList[0])
          TrRegistryService.picture(getList[0].id).then(res => {
            this.$message.success(res.data)
          })
          break
      }
