...
export default {
  ...
  methods: {
    ...
    getMaterialList () {
      ...
      MmTrWeighService.list(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        ...
        case 'copy':
          ...
          let id = getList[0].id
          MmTrWeighService.copy(id).then(res => {
            this.$message.success('操作成功')
          })
          break
        case 'down':
          ...
          MmTrWeighService.down(getList[0].id).then(res => {
            if (res.success) {
              this.$message.success(res.msg)
              this.getMaterialList()
            }
        ...
        case 'reversedown':
          ...
          MmTrWeighService.reversedown(getList[0].id).then(res => {
            if (res.success) {
              this.$message.success(res.msg)
            }
          })
