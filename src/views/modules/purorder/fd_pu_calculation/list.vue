...
export default {
  ...
  methods: {
    ...
    getMaterialList () {
      ...
      FdPuCalculationService.list(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        ...
        case 'disable':
          ...
          FdPuCalculationService.disable({
            ids: result
          }).then(res => {
            this.$message.success(res.msg)
          })
        ...
        case 'obsolete':
          ...
          FdPuCalculationService.obsolete({
            ids: result,
            check: false
          }).then(res => {
            this.$message.success(res.msg)
        ...
        case 'copy':
          ...
          let id = getList[0].id
          FdPuCalculationService.copy(id).then(res => {
            this.$message.success(res.msg)
          })
          break
      }
