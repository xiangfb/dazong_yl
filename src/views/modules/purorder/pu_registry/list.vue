...
export default {
  ...
  methods: {
    popupConfirm () { // 弹窗资源点击确定触发  data为已选跨页数据
      ...
      PuRegistryService.updateWeighsByNotice({
        noticeId: noticeId,
    ...
    getReg (code) {
      ...
      PuRegistryService.list(params).then(res => {
        if (res.success) {
    ...
    supplementCard (code, id) {
      PuRegistryService.supplementCard({
        id: id,
        cardCode: code
      }).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        ...
        case 'againMatch':
          ...
          PuRegistryService.againMatch(getList[0].id).then(res => {
            if (res.success) {
              this.$message.success('操作成功')
              this.getMaterialList()
            }
        ...
        case 'safeUpdate':
          ...
          PuRegistryService.getSub(getList[0].id).then(res => {
            if (!res.data[0] || res.data[0].reWeigh01 === null || res.data[0].reWeigh01 === '') {
        ...
        case 'copy':
          ...
          let id = getList[0].id
          PuRegistryService.copy(id).then(res => {
            if (res.success) {
              this.$message.success('操作成功')
              this.getMaterialList()
            }
        ...
        case 'upControlPoint':
          ...
          console.log(getList[0])
          PuRegistryService.upControlPoint({
            id: getList[0].id,
        ...
        case 'downControlPoint':
          ...
          console.log(getList[0])
          PuRegistryService.downControlPoint({
            id: getList[0].id,
        ...
        case 'picture':
          ...
          console.log(getList[0])
          PuRegistryService.picture(getList[0].id).then(res => {
            this.$message.success(res.data)
          })
          break
      }
