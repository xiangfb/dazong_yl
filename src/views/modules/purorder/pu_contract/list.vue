...
export default {
  ...
  methods: {
    ...
    getMaterialList () {
      ...
      PuContractService.list(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        ...
        case 'copy':
          ...
          let id = getList[0].id
          PuContractService.copy(id).then(res => {
            this.$message.success(res.data)
          })
          break
      }
