...
import dynamicService from 'service/modules/system/dynamicReport/dynamicReport'
export default {
  name: 'dynamic',
  data () {
    return {
  ...
  methods: {
    ...
    getMaterialList () {
      ...
      dynamicService.list(params).then(res => {
        if (res.success) {
    ...
    butEvent (e) {
      ...
      switch (e) {
        case 'update':
          ...
          let templateType = this.$refs.com.$refs.custom.$refs.editable.getSelecteds()[0].templateType
