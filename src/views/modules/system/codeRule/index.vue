...
<template slot-scope="scope" slot="enableOrg">
      {{scope.row.enableOrg===1?'启用':'未启用'}}
  </template>
      </avue-crud>
    </basic-container>
    <basic-container v-if="showAdd" class="p-n">
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          <el-col :span="12">
            <el-form-item prop="ruleCode" label="编码规则">
          ...
          <el-col :span="12">
            <el-form-item prop="dateType" label="时间类型">
              <el-input v-model="form.dateType"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item prop="serialLength" label="流水号长度">
              <el-input v-model="form.serialLength"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item prop="cronJob" label="启用编码">
              <el-switch v-model="form.enableOrg"
              active-value="1"
              inactive-value="0">
              </el-switch>
            </el-form-item>
