  ...
  <div style="width: 95%; height: 100%;margin: 0 auto;">
    <template>
      <div style="width: 100%;margin-top: 5px;margin-bottom: 5px;">
        ...
        <el-button type="danger" @click="delButton">
          删除
        </el-button >
        ...
        <el-button style="float: right;margin: 0;height: 38px;" type="primary" icon="el-icon-search" @click="searchUser"></el-button>
        <el-input v-model="input" placeholder="姓名/手机号" type="text" style="width: 300px !important;float: right;padding-right: 4px;"></el-input>
      </div>
    </template>
    <el-table
      ref="multipleTable"
    ...
    <!--添加对话框-->
    <el-dialog title="添加护士" :visible.sync="dialogFormVisible">
      <el-form ref="form" :model="form" label-width="80px">
        <el-tabs type="border-card">
          <el-tab-pane label="基本信息">
            <div style="margin: 0;padding: 0;width: 50%;height: 400px;float: left;">
              <div style="width: 100%;height: 400px;">
                <span>姓名:&nbsp;&nbsp;&nbsp;&nbsp;</span><el-input v-model="form.name" style="width: 120px !important;height: 38px!important;"  />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <span>性别:&nbsp;&nbsp;</span>&nbsp;&nbsp;
          ...
          <el-tab-pane label="更多个人信息">
              <span>护士执业证编号:&nbsp;&nbsp;</span>
              <el-input style="width: 200px !important;margin-bottom: 10px;" v-model="form.license"/><br>
              <span>护士资格证编号:&nbsp;&nbsp;</span>
              <el-input style="width: 200px !important;margin-bottom: 10px;" v-model="form.qualification"/><br>
              <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;助产证编号:&nbsp;&nbsp;</span>
              <el-input style="width: 200px !important;margin-bottom: 10px;" v-model="form.midwifeNum"/><br>
              <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;其他证件:&nbsp;&nbsp;</span>
              <el-input style="width: 200px !important;margin-bottom: 10px;" v-model="form.restsCredentials"/>
          </el-tab-pane>
        </el-tabs>
        <div style="margin: 0 auto;width: 100%;">
          <el-button @click="addnurse" style="margin-left: 40%">取 消</el-button>
...
<script>
  import {addnurse,fechList,validateMobile,ensureDel,getDept,dataPermissions,edit,findUser} from "@/api/admin/nurse"
  ...
  export default {
    ...
    methods: {
      ...
      theList(){
        fechList(this.page).then(response => {
      ...
      searchUser(){
        if(this.input !=null && this.input !=''){
          ...
          findUser(this.input,this.page).then(response =>{
