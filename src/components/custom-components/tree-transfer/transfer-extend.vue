  ...
  <div class="transfer" :style="{ width, height }">
    <template v-if="mode == 'transfer'">
      ...
      <div class="transfer-left">
        <h3 class="transfer-title flex flex-between">
          <div v-if="fromTitle">{{ fromTitle }}</div>
          <slot v-else name="title-left"></slot>
          <el-input
            v-if="filter"
            :placeholder="placeholder"
            v-model="filterFrom"
            class="filter-tree-width-auto"
          >
          </el-input>
        </h3>
        <!-- 内容区 -->
      ...
      <div class="transfer-right">
        <h3 class="transfer-title flex flex-between">
          <span v-if="toTitle">{{ toTitle }}</span>
          <slot v-else name="title-right"></slot>
          <el-input
            v-if="filter"
            :placeholder="placeholder"
            v-model="filterTo"
